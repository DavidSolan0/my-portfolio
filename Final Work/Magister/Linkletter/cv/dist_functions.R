...
YPPP <- function(Yna, X, na_indices, K, n_sams, n_burn, n_skip, m, p, n) # I puede ser n (?)
{
  ...
  for (b in 1:B) 
  {
    Yna        <- sample_Y(n, na_indices, Yna, X, W, p, m, alpha, sig2, mu)
